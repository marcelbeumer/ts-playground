...
export const useGetLaunchesQuery = <
    ...
    useQuery<GetLaunchesQuery, TError, TData>(
      variables === undefined ? ['GetLaunches'] : ['GetLaunches', variables],
      fetcher<GetLaunchesQuery, GetLaunchesQueryVariables>(dataSource.endpoint, dataSource.fetchParams || {}, GetLaunchesDocument, variables),
      options
    );